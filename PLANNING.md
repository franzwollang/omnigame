...
**Hidden Simultaneous Guess Who Lite** (`commitReveal` under simultaneous
deduction — private query/guess then reveal).
...
**Guess Who And3 Lite**, **Simultaneous Guess Who Lite**, **Simultaneous Guess Who And Lite**,
