...
`objective.looseNetDeath` (M78).

**Open (Phase 2 — see `OPEN_ISSUES.md`):**

- **Next:** pick smallest new seam under `next-missing-mechanism` (e.g.
  fuller Go remainder beyond loose net; throw-in nets; fire→move only with
  anchor; realtime scheduler; simultaneous jump; reject recombinations)
- Deferred: fuller Go rules (loose net landed as M78; net as M77; nakade as
  M76; semeai as M75;
