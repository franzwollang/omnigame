...
Go Lite Dame Fill / `objective.dameFill` (M70).

**Open (Phase 2 — see `OPEN_ISSUES.md`):**

- **Next:** pick smallest new seam under `next-missing-mechanism` (e.g.
  fuller Go remainder beyond dame fill; fire→move only with anchor; realtime
  scheduler; simultaneous jump; reject recombinations)
- Deferred: fuller Go rules (dame fill landed as M70; Benson as M69); realtime scheduler;
