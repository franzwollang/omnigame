...
What’s **roadmap**, not fully realized yet: full Go rules, phases beyond fleet,
hidden simultaneous on hex/graph (if a new observe/legal seam), and a larger set
of reusable operators/constraints.
