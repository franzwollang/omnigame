...
Go Lite Nakade (`go-lite-nakade` / `objective.nakadeDeath`) landed as **M76**.
Go Lite Semeai closed as M75; Territory Prisoners as M74; Ladders as M73;
...
jump as M47; memory flip as M46; mustCapture as M45; rectangle flood_reveal as
M44. P4 tooling-ci and semantics-doc-refresh already closed (M41–M42;
semantics notes continue per mechanism).

Pick the smallest remaining new seam that existing primitives cannot express,
e.g.:

- Fuller Go remainder beyond nakade (e.g. nets / geta / deeper semantic L&D)
...
- Hex/graph seki, dead-stone, Benson, dame-fill, mark-dead, mark-dead-resume,
  ladderDeath, territoryPrisoners, semeaiDeath, or nakadeDeath presets
...
`next-missing-mechanism` (post-nakade; prefer nets / deeper L&D or other
