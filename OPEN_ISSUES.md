...
Simultaneous Jump Race (`simultaneous-jump-race` / joint single-hop jump)
landed as **M81**. Go Lite Approach Net closed as M80; Sente Ladder as M79;
Loose Net as M78; Net as M77; Nakade as M76; Semeai as M75; Territory
...
- Ordered simultaneous jump / commitReveal + jump / multi-action simultaneous
  jump (composition follow-ons to M81)
...
`next-missing-mechanism` (post-simultaneous-jump; prefer ordered/commitReveal
