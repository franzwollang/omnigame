...
Go Lite L4-Nakade (`go-lite-l4-nakade` / `objective.l4NakadeDeath` L4 /
tetromino L-J bulky big-eye vital-fill removal at scoring; Benson-alive /
T1-miss / L-miss / square-miss / pyramid-miss / twisted-miss / chase-miss
unique board) landed as **M90**.
Go Lite Twisted-Nakade closed as M89; Pyramid-Nakade as M88; Square-Nakade as
M87; L-Nakade as M86; Hidden Double Simultaneous Jump Race as M85; Double
...
- Fuller Go remainder (throw-in / snapback / connect-and-die) — only if a
  ...
  did not; also escape L4/twisted/pyramid/square/L now)
- Straight-4 / bulky-5 nakade tables (only if uniquely contrastable vs
  L4/twisted/pyramid/square under 1-ply vital-fill; probe: straight-4/bulky-5
  failed Benson on 7×7 shell)
...
`next-missing-mechanism` (post-L4-nakade; prefer a uniquely expressible Go
