...
Go Lite Straight-4-Nakade (`go-lite-straight4-nakade` /
`objective.straight4NakadeDeath` I-tetromino / straight-4 bulky big-eye
vital-fill removal at scoring; Benson-alive / T1-miss / L-miss / square-miss /
pyramid-miss / twisted-miss / L4-miss / chase-miss unique board on 7×8) landed
as **M91**.
Go Lite L4-Nakade closed as M90; Twisted-Nakade as M89; Pyramid-Nakade as M88;
...
- Fuller Go remainder (throw-in / snapback / connect-and-die) — only if a
  ...
  did not; also escape straight-4/L4/twisted/pyramid/square/L now)
- Bulky-5 / plus / P / other pentomino nakade tables (only if uniquely
  contrastable vs straight-4/L4/twisted/pyramid/square under 1-ply vital-fill;
  prior probe: bulky-5 failed Benson on 7×7 shell — may need larger board)
...
- Hex/graph seki, dead-stone, Benson, dame-fill, mark-dead, mark-dead-resume,
  ...
  straight4NakadeDeath, netDeath, looseNetDeath, senteLadderDeath, or
...
`next-missing-mechanism` (post-straight-4-nakade; prefer a uniquely
expressible Go seam or realtime over topology ports).
