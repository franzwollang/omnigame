...
Go Lite Semeai (`go-lite-semeai` / `objective.semeaiDeath`) landed as **M75**.
Go Lite Territory Prisoners closed as M74; Ladders as M73; Mark Dead Resume as
...
- Fuller Go remainder beyond semeai (e.g. nakade / nets / deeper semantic L&D)
...
- Hex/graph seki, dead-stone, Benson, dame-fill, mark-dead, mark-dead-resume,
  ladderDeath, territoryPrisoners, or semeaiDeath presets (topology ports —
...
`next-missing-mechanism` (post-semeai; prefer nakade / nets / deeper L&D or
