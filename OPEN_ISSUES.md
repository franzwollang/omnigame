...
Go Lite Approach Net (`go-lite-approach-net` / `objective.approachNetDeath`)
landed as **M80**. Go Lite Sente Ladder closed as M79; Loose Net as M78; Net
as M77; Nakade as M76; Semeai as M75; Territory Prisoners as M74; Ladders as
...
- Fuller Go remainder beyond approach nets (e.g. throw-in / snapback /
  connect-and-die)
...
`next-missing-mechanism` (post-approach-net; prefer throw-in / connect-and-die
or other genuine seams over topology ports).
