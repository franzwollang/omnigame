...
Go Lite Sente Ladder (`go-lite-sente-ladder` / `objective.senteLadderDeath`)
landed as **M79**. Go Lite Loose Net closed as M78; Net as M77; Nakade as M76;
...
seki as M67; komi as M66; hub-graph forward-only men as M65; graph
...
- Fuller Go remainder beyond sente ladder (e.g. throw-in nets / approach-move
  nets / connect-and-die)
...
- Hex/graph seki, dead-stone, Benson, dame-fill, mark-dead, mark-dead-resume,
  ...
  looseNetDeath, or senteLadderDeath presets (topology ports — only if a new
  seam appears)
...
`next-missing-mechanism` (post-sente-ladder; prefer throw-in / deeper L&D or
other genuine seams over topology ports).
